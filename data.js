...
const Database = [
    ...
    },
    {
      ...
      respuestaCorrecta: "Podes hacer la transferencia a tu cuenta de MercadoPago asociada a la cuenta de MercadoLibre con la cual estas haciendo la consulta, y a la hora de ofertar, pagar con tarjeta de crédito más el dinero en cuenta. Esto es siempre y cuando la compra la realice por MercadoLibre.",
    },
    {
      id: 21,
    ...
    },
    {
      ...
      respuestaCorrecta: " Gabinete: Thermal Take Versa T35 TG, XPG Defender Pro . Procesadores: Intel 10ma gen. SOCKETS DE CPU COMPATIBLES: INTEL: LGA 1700, LGA2066, LGA2011-v3, LGA2011, LGA1200, LGA1151, LGA1150, LGA1155, LGA1156. AMD: AM5, AM4, AM3 +, AM3, AM2 +, AM2, FM2 +, FM2, FM1. Mother: MSI B 560M, ",
    },
    {
      id: 33,
    ...
    },
    {
      ...
      articulo: "Generico",
      sku: "",
      pregunta: "Problema con una compra, reclamo, devolución.",
      respuestaCorrecta: "Si la compra la realizó a nuestra cuenta comuníquese con la mensajería privada post compra desde el artículo que compró, en la sección de compras de su cuenta de MercadoLibre",
    },
    {
      id: 58,
    ...
    },
    {
      ...
      sku: "6UU47A",
      pregunta: "Es compatible con la Mac?",
    ...
    },
    {
      ...
      respuestaCorrecta: " No sabría decirte, mas allá del conector habría que ver si el mapeado de los pines es igual. Es para la fuentes modulares de la serie MWE Gold Cooler Master",
    },
    {
      id: 67,
      ...
      respuestaCorrecta: "La acción por defecto es escanear el código y presionar Enter, no obstante, en el manual posee también otras opciones o configuraciones que pueden elegirse siguiendo los pasos indicados en el mismo",
    },
    {
      id: 68,
      articulo: "Generico",
    ...
    },
    {
      ...
      respuestaCorrecta: "Los productos que tienen habilitada la promoción de Ahora 12 deben tener algún inconveniente interno con la función de carrito de compras propia de MercadoLibre y desconocemos el propósito real. Si no tienes la necesidad de usar Ahora 12, podemos sacarlo momentáneamente para que puedas hacer tu compra y agregarlo al carrito, ya que de esa forma volvería a aparecer el botón. En caso contrario, si necesitas hacer uso de esta promoción (Ahora 12), la única forma de que puedas ofertar será de forma individual para cada producto, sin la posibilidad de comprar con el carrito.",
    },
    {
      id: 70,
      articulo: "Cooler Cpu Cooler Master Hyper H411r Led White Amd Intel",
      sku: "RR-H411-20PW-R1",
      pregunta: "Es compatible con el Mother XXXXXX",
    ...
    },
    {
      ...
      respuestaCorrecta: "Hola, solo posee un solo slot de almacenamiento M2 disponible que, en este caso, ya viene ocupado con el SSD mencionado en la descripción (480gb), solo se puede intercambiar el mismo, pero no agregar mas unidades.",
    },
    {
      id: 72,
